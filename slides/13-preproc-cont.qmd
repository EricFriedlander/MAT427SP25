...
```{r}
preprocessors <- list(
  knn_impute = knn_preproc1,
  mean_impute = knn_preproc2,
  median_imput = knn_preproc3
)
...
```{r}
knn_models <- workflow_set(preprocessors, models, cross = TRUE)
  
all_models <- as_workflow_set(lm = lm_wf) |> 
