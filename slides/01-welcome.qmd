...
-   Access RStudio through [RStudio Server](https://rstudio.collegeofidaho.edu/)
:::
:::
...
-   **Perform:** Put together what you've learned to analyze real-world data
    ...
    -   One Hack-a-thon/Presentation (team)
...
See the [syllabus](https://mat427sp25.netlify.app/syllabus.html) for details on how the final letter grade will be calculated.
...
-   See the [Course Support](https://mat427sp25.netlify.app/support.html) page for more details

# Course policies

## Late Homework

-   Late homework will be accepted without penalty for up to week after it is due. However, late homework will not receive any feedback if it is received one I've started grading it. Your homework will serve as the foundation for your portfolio's.


## School-Sponsored Events

If an assignment must be missed due to a school-sponsored event, you must let me know at least a week ahead of time so that we can schedule a time for you to make up the work before you leave. If you must miss an assignment due to illness, you must let me know as soon as possible and, if practicable, before the assignment is due. Unless there are exigent circumstances, failure to adhere to this policy will result in a 35% penalty on the corresponding assignment.  
