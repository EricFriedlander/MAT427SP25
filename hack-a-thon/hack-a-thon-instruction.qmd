...
1. An HTML file outlining your modeling process. This should following the same guidelines for the [Job Application 2 Resources](jobs/job-app-2-resources.qmd).
2. A `.csv` file containing a vector of your predictions for whether the individuals in the test set make more than $50,000. That is, you will create a length **13,480** vector of `0`s and `1`s where `1` indicates an individual makes MORE than \$50K and write them to a file using:
