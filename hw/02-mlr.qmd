...
1.  [Click this link](https://classroom.github.com/a/vKdMyAYm) to accept the assignment and enter your team name.
...
Your prediction task in this homework will be to predict `Sales` from some combination of the other variables. Look at the help documentation for this data to explore the available variables. 
